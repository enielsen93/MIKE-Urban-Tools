...
class CompareMikeModels(object):
    ...
    def getParameterInfo(self):
        ...
        ignore_fields = arcpy.Parameter(
            ...
            multiValue=True,
            direction="Input")
        ignore_fields.filter.list = ["SHAPE", "Slope", "UpLevel_C", "DwLevel_C", "UpLevel", "DwLevel", "Diameter", "NetTypeNo", "GroundLevel", "CriticalLevel"]
        ignore_fields.value = ["Slope", "UpLevel_C", "DwLevel_C", "CriticalLevel"]
