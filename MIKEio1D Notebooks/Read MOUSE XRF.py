...
result_file = r"C:\Users\elnn\OneDrive - Ramboll\Documents\Musikkvartereret\PlanScenarie1\MK_PlanScenarie3_002\CDS10_4hr_143_Plan_NW_us4070Base.XRF"
MU_model = r"C:\Users\elnn\OneDrive - Ramboll\Documents\Musikkvartereret\PlanScenarie1\MK_PlanScenarie3_002\MK_PlanScenarie3_003.mdb"
post_name = ""
...
for ext in [".prf", ".PRF", ".xrf", ".XRF"]:
    new_filename = os.path.basename(result_file).replace(ext, "%s.shp" % (post_name))
try:
