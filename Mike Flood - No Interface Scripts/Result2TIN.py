...
dfsu_file = r"C:\Users\ELNN\OneDrive - Ramboll\Documents\Aarhus Vand\Vesterbro Torv\MIKE_URBAN\05_RESULTS\03_FLOOD\2023-10-17\VBT_STATUS_002_v4_m21fm - Result Files\VBT_STATUS_CDS_20_138_FMBaseDefault_2D_Flood_statistics.dfsu"
...
with arcpy.da.InsertCursor(os.path.join(nodesPath,nodesName), ["SHAPE@"]) as cursor:
    for element_i, element in enumerate(element_coordinates):
        cursor.insertRow([arcpy.Point(element[0], element[1], float(dfs_read_data[0,0,element_i]))]) # node[2] +
