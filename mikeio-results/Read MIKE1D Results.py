...
if True:
    ...
    res1d_file = r"C:\Users\ELNN\OneDrive - Ramboll\Documents\Aarhus Vand\Kongelund og Marselistunnel\MIKE\KOM_STATUS_002\KOM_STATUS_CDS_10_124Base.res1d"
    MU_model = r"C:\Users\ELNN\OneDrive - Ramboll\Documents\Aarhus Vand\Kongelund og Marselistunnel\MIKE\KOM_STATUS_002\KOM_STATUS_002.mdb"
    ...
    with alive_bar(len(reaches)) as bar:
    ...
    with arcpy.da.InsertCursor(nodes_output_filepath, ["SHAPE@", "MUID", "Diameter", "Invert_lev", "Max_elev", "Flood_dep", "Flood_vol", "NetTypeNo", "max_hl", "max_I_V", "flow_area", "flow_diam"]) as cursor:
        with alive_bar(len(df.data.Nodes)) as bar:
